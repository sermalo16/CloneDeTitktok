...
import { styles } from "./VideoData.style";
...
export  function VideoData(props) {
  ...
  return (
    <View style={styles.content}>
      ...
      <Pressable style={styles.imageContainer} onPress={selectedImageVideo}>
        <Image source={{uri: formik.values.imageUri || null}} style={styles.image}/>
