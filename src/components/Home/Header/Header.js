  ...
  return (
    <SafeAreaView style={styles.content}>
        ...
        <Pressable onPress={() => onChangeTypeVideos(ENV.TYPE_VIDEO.FOLLOWING)}>
            <Text style={typeVideos === ENV.TYPE_VIDEO.FOLLOWING ? styles.active : styles.inactive}>Siguiendo</Text>
        </Pressable>

        <Text> | </Text>

        <Pressable onPress={() => onChangeTypeVideos(ENV.TYPE_VIDEO.FOR_YOU)}>
            <Text style={typeVideos === ENV.TYPE_VIDEO.FOR_YOU ? styles.active : styles.inactive}>Para ti</Text>
        </Pressable>
