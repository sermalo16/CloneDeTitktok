...
import { HomeStack, FriendsStack, UploadStack, NotificationsStack, AccountStack } from "./stacks";
...
function tabIcon(props){
  ...
  if(route.name === screen.upload.tab){
    return(
      ...
      size={size} 
      color={color} 
      containerStyle={{backgroundColor: "#fff", paddingHorizontal: 5, paddingVertical: 5, borderRadius: 6}}
      iconStyle={{
        color: "#000",
        fontSize: 14,
      }}
